...
module.exports.install = function (Vue) {
    ...
    var Progress = {
        ...
        start: function start(time) {
            ...
            this.state.timer = setInterval(function () {
                ...
                if (_this.$vm.RADON_LOADING_BAR.percent > 95 && (_this.$vm.RADON_LOADING_BAR.options.autoFinish === true || _this.$vm.RADON_LOADING_BAR.percent === 100)) {
                    _this.finish();
                }
            }, 100);
        },
    ...
    var progressOptions = assign(DEFAULT_OPTION, options);
